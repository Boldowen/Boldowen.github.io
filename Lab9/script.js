...
function convertCurrency() {
    ...
    if (!isNaN(amount)) {
        ...
        resultAmountSpan.textContent = result.toFixed(2); // Хоёр оронтой тоогоор харуулах
    } else {
        resultAmountSpan.textContent = 'Буруу утга оруулсан байна';
    }
}

// Эхлэх үед валютуудыг дүүргэх
populateCurrencies();